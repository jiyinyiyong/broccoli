...
define(function(require, exports) {
  var article, article_data, auth, backend, config, editor, my, paper, popup, preview, reader, split_tags;
  ...
  exports.preview = function() {
    ...
    paper.find(".edit").click(function() {
      return exports.edit(data);
    });
    return paper.find(".save").click(function() {
  ...
  exports.edit = function(data) {
    ...
    paper.find(".save").click(function() {
      return backend.update(article_data());
    });
